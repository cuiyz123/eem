...
<!-- dtGrid -->
<script type="text/javascript" src="<%=path%>/component/jquery.dtGrid.v1.1.9.bak/jquery.dtGrid.js"></script>
...
<script type="text/javascript" src="<%=path%>/component/ztree/js/jquery.ztree.exedit.js"></script>
