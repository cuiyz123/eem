		...
		init : function(options, name) {
			...
			var dtGridObject = {
				...
				constructGrid : function(){
                    ...
                    //add by wangzwty@inspur.com
                    //BEGIN
                    gridContent += '<div class="div1" id="dt_grid_'+dtGridReflectionObj.option.id+'-header-container">';
                    //END
                    ...
                    //add by wangzwty@inspur.com
                    //BEGIN
					gridContent += '<div class="div2" id="dt_grid_'+dtGridReflectionObj.option.id+'-tbody-container"><table class="dt-grid '+dtGridReflectionObj.option.tableClass+'" id="dt_grid_'+dtGridReflectionObj.option.id+'" style="margin-bottom:0;'+dtGridReflectionObj.option.tableStyle+'">';
                    //END
                    //构建表格
                    gridContent += '	<tbody>';
                    ...
                    //END
                        ...
                        //END
						dtGridReflectionObj.reload();       //2018.4.2 jw
					});
					//绑定复选方法
