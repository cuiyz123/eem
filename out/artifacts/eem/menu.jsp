            ...
            <div id="model-title-container">
                ...
                <ul id="menu-ul">
                    <%
                        ...
                        uniMenuMap.put("todoAudit","eemCommonController.do?method=todo&type=1&nodeID=todoAudit&&type=1:待审核");
                        uniMenuMap.put("alreadyAudit","eemCommonController.do?method=already&nodeID=alreadyAudit:已审核");
                        uniMenuMap.put("dataQuery","eemCommonController.do?method=initQueryData&nodeID=dataQuery:数据查询");
                        uniMenuMap.put("dataQueryAll","eemCommonController.do?method=initQueryDataAll&nodeID=dataQueryAll:公布版数据下载");
                        ...
                        uniMenuMap.put("reportDeductData","deductController.do?method=initReport&nodeID=reportDeductData:集团扣分上报");
                        uniMenuMap.put("deductAnalysis","deductController.do?method=initAnalysis&nodeID=reportDeductData:集团扣分统计");
                        uniMenuMap.put("downDeductData","deductController.do?method=initQueryDataAll&nodeID=reportDeductData:集团扣分公示版下载");
                        uniMenuMap.put("analysis","base/page/countAnalysis.jsp:统计分析");
                        uniMenuMap.put("notice","base/page/notice.jsp:后评价系统通知");
                        uniMenuMap.put("managerTemplate","eemCommonController.do?method=initManagerTemplate:按专业配置所有模板");
                        ...
                        uniMenuMap.put("tempManager","eemTemplateController.do?method=initTempPage:模板管理和说明书");
                      ...
                      //  uniMenuMap.put("deviceReportManager","base/page/deviceReportManager.jsp:设备类型与填报模板关系");
                        ...
                        //增加总部上报功能  等同省份上报  jw4.16   &nodeID=UNI_reportData
                        //uniMenuMap.put("reportData","reportController.do?method=initReport:上报数据");
                       ...
                       // uniMenuMap.put("deviceTypeManager","base/page/deviceTypeManager.jsp:设备类型管理");
                        ...
                        uniMenuMap.put("todoApply","eemCommonController.do?method=todoApplyaaa&type=1&nodeID=todoApply:待办申请");
                        uniMenuMap.put("alreadyApply","eemCommonController.do?method=todoApplyaaa&type=2&nodeID=alreadyApply:已办申请");
                         //jw 3.2 gai
                        Map<String,String> proMenuMap = new HashMap<String, String>();
                        proMenuMap.put("todoAudit","eemCommonController.do?method=todo&type=1alreadyAudit&nodeID=PRO_todoAudit:待审核");
                        proMenuMap.put("alreadyAudit","eemCommonController.do?method=already&nodeID=PRO_alreadyAudit:已审核");
                        proMenuMap.put("reportData2","reportController.do?method=initReport&type=2&nodeID=PRO_reportData2:上报数据(数据流向省内)");
                        proMenuMap.put("reportData","reportController.do?method=initReport&type=1&nodeID=PRO_reportData:上报数据");
                        proMenuMap.put("dataQuery","eemCommonController.do?method=initQueryData&nodeID=PRO_dataQuery:数据查询");
                       //proMenuMap.put("dataQueryAll","eemCommonController.do?method=initQueryDataAll&nodeID=PRO_dataQueryAll:公布版数据下载");
                        ...
                        proMenuMap.put("tempManager","eemTemplateController.do?method=initTempPage:模板管理和说明书");
                      ...
                      //  proMenuMap.put("alreadyApply","base/page/alreadyApply.jsp:已办申请");
                        ...
                        proMenuMap.put("todoApply","eemCommonController.do?method=todoApplyaaa&type=1&nodeID=todoApply:待办申请");
                        proMenuMap.put("alreadyApply","eemCommonController.do?method=todoApplyaaa&type=2&nodeID=alreadyApply:已办申请");
                        //jw 3.2 gai

                        proMenuMap.put("areportApply","eemCommonController.do?method=todo&type=2&nodeID=areportApply:已申请重新上报");
                        proMenuMap.put("managerTemplate","eemCommonController.do?method=initManagerTemplate:按专业配置所有模板");



                        Map<String,String> cityMenuMap = new HashMap<String, String>();
                        cityMenuMap.put("todoAudit","eemCommonController.do?method=todo&type=1&nodeID=CITY_todoAudit:待审核");
                        cityMenuMap.put("alreadyAudit","eemCommonController.do?method=already&nodeID=CITY_alreadyAudit:已审核");
                        cityMenuMap.put("reportData","reportController.do?method=initReport&type=2&nodeID=CITY_reportData:上报数据");
                        cityMenuMap.put("dataQuery","eemCommonController.do?method=initQueryData&nodeID=CITY_dataQuery:数据查询");
                       // cityMenuMap.put("dataQueryAll","eemCommonController.do?method=initQueryDataAll&nodeID=CITY_dataQueryAll:公布版数据下载");
                        ...
                        cityMenuMap.put("tempManager","eemTemplateController.do?method=initTempPage:模板管理和说明书");
                        cityMenuMap.put("areportApply","eemCommonController.do?method=todo&type=2&nodeID=CITY_areportApply:已申请重新上报");
                        cityMenuMap.put("managerTemplate","eemCommonController.do?method=initManagerTemplate:按专业配置所有模板");
                        ...
                        if(participants.contains("managerTemplate")&&aimMap.containsKey("managerTemplate")){
                            menuList.add("managerTemplate");
//                            firstMenu ="deviceTypeManager";
                        }
                    ...
                    <%--   4.16 jw添加总部上报//注意%> --%>
                    <li><a href="reportController.do?method=initReport&type=1&nodeID=PRO_reportData" target="__menu_body">总部上报数据</a></li>
                    <%-- //--%>
                    <%
                                }else if(userEntity.getCategory().equals("PRO")){
                                        for(String menu : menuList){
                    ...
                    <li><a href="<%=cityMenuMap.get(menu).split(":")[0]%>" target="__menu_body"><%=cityMenuMap.get(menu).split(":")[1]%></a></li>
                                ...
                                %>
                                    ...
                                    <li><a href="eemCommonController.do?method=initManagerTemplate" target="__menu_body">按专业配置所有模板</a></li>
