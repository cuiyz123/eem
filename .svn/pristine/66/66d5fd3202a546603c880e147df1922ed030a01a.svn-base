<%@ page import="com.primeton.workflow.deploy.usrcfg.User" %>
<%@ page import="java.util.List" %>
<%@ page import="com.metarnet.eomeem.model.VendorEntity" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ include file="/base/basePage2.jsp" %>
<html>
<head>
    <title>报表与厂商关系维护11</title>
    <%
...
<body>
<div class="big-title-metar">报表与厂商关系维护11</div>
