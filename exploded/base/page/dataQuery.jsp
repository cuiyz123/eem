...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-1 col-sm-1 btn btn-danger" style="width: 120px" id="collect_2_2_5">上报结果查看</div>
        <%
        } else if ("PRO".equals(userEntity.getCategory())) {
        %>
        <%
            UserEntity userEntity1 = (UserEntity)session.getAttribute("globalUniqueUser");
            String username = userEntity1.getUserName();
            request.setAttribute("username123", username);
        %>
...
//        $('#custom_search_2_2_3').click(customSearch_2_2_3);
        ...
        $('#collect_2_2_5').click(showReportResult);
    });
</script>
</body>
</html>
