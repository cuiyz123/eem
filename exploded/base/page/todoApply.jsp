    ...
    <script type="text/javascript">
        ...
        var dtGridColumns_2_1_2 = [
            ...
            },
            {
                ...
                columnClass: 'text-center',
                resolution: function (value, record, column, grid, dataNo, columnNo) {
                    return  "<a href='javascript:;' onclick='allAudit(" + record.objectId + ")'>操作</a>";
            }
            }
        ];
        var dtGridOption_2_1_2 = {
            lang : 'zh-cn',
            ajaxLoad : true,
           /* loadURL: '<%=path%>/eemCommonController.do?method=queryApplyList&type=1',*/
            loadURL: '<%=path%>/eemCommonController.do?method=queryApplyList&type=1&tempIds='+encodeURIComponent(encodeURIComponent('${tempIds}')),
            <%-- //jw  修改地址 todoApply 3.2--%>
...
//            $("#allAudit").click(allAudit);
        ...
        function allAudit(objectId){
            ...
            pcSignFormLink('__pass_modal_body',objectId,'edit');
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-1 col-sm-1" style="padding: 0px;margin-left: 10px">粒度：</div>
...
<div id="__pass_modal_window" class="__link_dialog_container modal">
    <div class="modal-header">申请重报数据回复
